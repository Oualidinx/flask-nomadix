...
#         voyages = Trip.query.filter(and_(Trip.is_deleted == False,
...
#                     for a in v.agencies:
#                         try:
#                             v_for_a = TripForAgency.query.filter(and_(VoyageForAgency.fk_voyage_id==v.id,VoyageForAgency.fk_agency_id==a.id)).first()
#                             if v_for_a:
